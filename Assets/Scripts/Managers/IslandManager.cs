...
public class IslandManager : MonoBehaviour
{
    ...
    public IEnumerator ShakeCamera()
    {
        ...
        StartCoroutine(Camera.main.GetComponent<CameraShake>().Shake(0.1f, .1f));
        yield return null;
    }

    public IEnumerator GameComplete()
    {
        GameObject.Find("Player").GetComponent<FPPlayerMove>().ascend = true;
        ...
        {
            if (islands[i].GetComponent<IslandMove>() != null)
            {
                islands[i].GetComponent<IslandMove>().islasBajan = true;
                islands[i].GetComponent<IslandMove>().islaSube  = false;
    ...
    void Update()
    {   
        //if (Input.GetKeyDown("o")) StartCoroutine("GameComplete"); //BORRAR ESTO LUEGO!
    }
    ...
    {        
        ...
        {
            case "2":
                Isla2.GetComponent<IslandMove>().islaSube = true;
                break;
            case "3":
                Isla3.GetComponent<IslandMove>().islaSube = true;
                break;
            case "4":
                Isla4.GetComponent<IslandMove>().islaSube = true;
                break;
            case "5":
                Isla5.GetComponent<IslandMove>().islaSube = true;
                break;
            case "6":
                Isla6.GetComponent<IslandMove>().islaSube = true;
                break;

            case "A":
                IslaA.GetComponent<IslandMove>().islaSube = true;
                break;
            case "B":
                IslaB.GetComponent<IslandMove>().islaSube = true;
                break;
            case "C":
                IslaC.GetComponent<IslandMove>().islaSube = true;
                break;
            ...
            case "Z":
                //debe pasar una sola vez
                if (!elevatorLock)
                {
                    ElevadorZ.GetComponent<ElevatorMove>().elevadorSube = true;
                    GameObject.Find("1Ba").transform.SetParent(ElevadorZ);
                    GameObject.Find("Player").GetComponent<FPPlayerMove>().canMove = false;
                    GameObject.Find("Player").transform.SetParent(ElevadorZ);
                    Camera.main.GetComponent<HoldObjects>().canHold = false;
                ...
                break;
            case "X":
                ElevadorX.GetComponent<ElevatorMove>().elevadorSube = true;
                //congelar al player
                break;
        }
    }
    public void SubirPuente(string ControlledBridges)
    {
        ...
        {
            case "1":
                Puente1.GetComponent<BridgeMove>().puenteSube = true;
                break;
            case "2":
                Puente2.GetComponent<BridgeMove>().puenteSube = true;
                break;
            case "3":
                Puente3.GetComponent<BridgeMove>().puenteSube = true;
                break;
            case "4":
                Puente4.GetComponent<BridgeMove>().puenteSube = true;
                break;
            case "5":
                Puente5.GetComponent<BridgeMove>().puenteSube = true;
                break;
            case "6":
                Puente6.GetComponent<BridgeMove>().puenteSube = true;
                break;

            case "A":
                PuenteA.GetComponent<BridgeMove>().puenteSube = true;
                break;
            case "B":
                PuenteB.GetComponent<BridgeMove>().puenteSube = true;
                break;
            case "C":
                PuenteC.GetComponent<BridgeMove>().puenteSube = true;
                break;

            case "Z":
                PuenteZ.GetComponent<BridgeMove>().puenteSube = true;
                break;
        }
    }
    public void BajarPuente(string ControlledBridges)
    {
        ...
        {
            case "1":
                Puente1.GetComponent<BridgeMove>().puenteSube = false;
                break;
            case "2":
                Puente2.GetComponent<BridgeMove>().puenteSube = false;
                break;
            case "3":
                Puente3.GetComponent<BridgeMove>().puenteSube = false;
                break;
            case "4":
                Puente4.GetComponent<BridgeMove>().puenteSube = false;
                break;
            case "5":
                Puente5.GetComponent<BridgeMove>().puenteSube = false;
                break;
            case "6":
                Puente6.GetComponent<BridgeMove>().puenteSube = false;
                break;

            case "A":
                PuenteA.GetComponent<BridgeMove>().puenteSube = false;
                break;
            case "B":
                PuenteB.GetComponent<BridgeMove>().puenteSube = false;
                break;
            case "C":
                PuenteC.GetComponent<BridgeMove>().puenteSube = false;
                break;

            case "Z":
                PuenteZ.GetComponent<BridgeMove>().puenteSube = false;
                break;
